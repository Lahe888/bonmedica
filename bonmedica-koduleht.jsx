    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1120, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        <button onClick={() => setPage("home")} style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
          <div style={{ width: 36, height: 36, borderRadius: 10, background: "linear-gradient(135deg, #55C5A4, #2D5A7B)", display: "flex", alignItems: "center", justifyContent: "center" }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      {items.map((item, i) => (
        <div key={i} style={{ background: "#fff", borderRadius: 12, border: "1px solid #e8f0ec", overflow: "hidden" }}>
          ...
          {openIdx === i && (
            <div style={{ padding: "0 24px 20px", fontSize: 14, color: "#556671", lineHeight: 1.75 }}>
              {item.content}
            </div>
          )}
        </div>
...
const ContactBlock = ({ email = "bonmedica@bonmedica.eu" }) => (
  <div style={{ background: "#fff", borderRadius: 16, padding: 32, border: "1px solid #e8f0ec" }}>
    ...
    <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
      <Btn icon="arrowRight">Helista kohe</Btn>
      <Btn variant="outline" icon="arrowRight">Kirjuta e-mail</Btn>
    </div>
  </div>
);
...
const PageHero = ({ title, sub }) => (
  <div style={{ background: "linear-gradient(135deg, #f0f9f5, #e4f4ed)", padding: "56px 24px 48px" }}>
    <div style={{ maxWidth: 1120, margin: "0 auto" }}>
      ...
      <p style={{ fontSize: 16, color: "#556671", lineHeight: 1.7, maxWidth: 720 }}>{sub}</p>
    </div>
  </div>
);
...
const HomePage = ({ setPage }) => (
  <>
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 1120, margin: "0 auto", display: "flex", flexWrap: "wrap", gap: 48, alignItems: "center" }}>
        <div style={{ flex: "1 1 480px", minWidth: 280 }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <Btn icon="arrowRight">Võta ühendust</Btn>
            <Btn variant="outline">Lahtiolekuajad</Btn>
          </div>
        </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ textAlign: "center", padding: 32 }}>
                <Icon name="heart" size={48} color="#2D5A7B" />
                <p style={{ fontSize: 14, color: "#2D5A7B", marginTop: 12, fontWeight: 500 }}>BonMedica meeskond</p>
              </div>
            </div>
          </div>
        </div>
    ...
    {/* TUTVUSTUS */}
    <Section>
      <SectionTitle sub="Oleme väike ja pühendunud meeskond, kes teenindab Viimsi ja ümbruskonna perekondi. Meie jaoks ei ole te lihtsalt järjekorranumber — me tunneme oma patsiente nimepidi ja teame teie terviselugu.">
        Perearstikeskus, kus teid tuntakse
      </SectionTitle>
      <p style={{ fontSize: 15, color: "#556671", lineHeight: 1.7, maxWidth: 720 }}>
...
const PereodePage = () => (
  <>
    ...
    <Section bg="#F4F9F6">
      ...
      <Accordion items={[
        {
          icon: "activity", title: "Nõustamine ja terviseinfo — lähemalt",
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {
          icon: "syringe", title: "Protseduurid ja uuringud — lähemalt",
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {
          icon: "thermometer", title: "Krooniliste haiguste jälgimine — lähemalt",
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {
          icon: "baby", title: "Laste arengu jälgimine — lähemalt",
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <p>Täpsem info: ravijuhend.ee/tervishoiuvarav/juhendid/130/lapse-tervise-jalgimise-juhend</p>
            </div>
          ),
        },
        {
          icon: "globe", title: "Reisivaktsineerimine — lähemalt",
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
...
const Footer = ({ setPage }) => (
  <footer style={{ background: "#1A2E3B", padding: "48px 24px 32px" }}>
    <div style={{ maxWidth: 1120, margin: "0 auto" }}>
      <div style={{ display: "flex", flexWrap: "wrap", gap: 40, marginBottom: 32 }}>
        <div style={{ flex: "1 1 280px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            <div style={{ width: 32, height: 32, borderRadius: 8, background: "#2D5A7B", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{ flex: "1 1 200px" }}>
          <p style={{ fontSize: 13, fontWeight: 600, color: "rgba(255,255,255,0.5)", marginBottom: 12, textTransform: "uppercase", letterSpacing: "0.05em" }}>Leheküljed</p>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {Object.entries(PAGES).map(([key, label]) => (
              <button key={key} onClick={() => setPage(key)}
